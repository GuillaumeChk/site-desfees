	...
	<q-page>
		...
		<div class="wrapper">
			...
			<section class="q-gutter-y-md">
				<h5 class="q-px-md text-brand-2 q-py-lg">Des moments uniques...</h5>
				...
				<p class="q-px-md">
					...
					La piscine (profondeur : 1.50m.)chauffée plongeant sur la vallée, avec
					son eau cristalline réputée magique dans le Jura, ornée de reflets
					argentés et d’une superbe cascade scintillante, vous offrira une
					possibilité de nage à contre-courant, un soin de réflexologie
				...
				<p class="q-px-md">
					...
					Isabelle travaille dans les métiers de l’hôtellerie. En créant ce
					lieu, son rêve se réalise enfin d’accueillir et de choyer ses propres
					clients.
				</p>
				...
				></q-img>
				<p class="q-px-md">
					Un coin bibliothèque et TV sont à votre disposition.
				</p>
				...
				<p class="q-px-md">
					...
					phytothérapie, l'activité physique, la diététique et un style de vie
					sain et équilibré. Pour en savoir plus
					<a
				...
				<p class="q-px-md">
					...
					parc, une chaise haute et des jouets. Pour les balades à pied, un
					circuit de grandes randonnées passe devant la ferme. Des luges, boules
					de pétanque sont à votre disposition, elle peut également vous
					organiser : Des parties de pêche en rivière, des ballades équestres,
					VTT, vol en montgolfière, avion, parapente,
					<strong>sur commande</strong> arrangements floraux, bouquets de
					fleurs, paniers pique-niques, différents massages de bien-être&nbsp;et
