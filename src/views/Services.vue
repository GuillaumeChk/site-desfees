<template>
	<q-pages>
		<p>Des moments uniques...</p>
		<p>
			Au Domaine des Fées, quand le soleil rayonne et que le ciel devient bleu,
			vous pouvez accéder à un monde merveilleux.<br />
			La piscine (profondeur : 1.50m.)chauffée plongeant sur la vallée, avec son
			eau cristalline réputée magique dans le Jura, ornée de reflets argentés et
			d’une superbe cascade scintillante, vous offrira une possibilité de nage à
		...
		<p>
			...
			confort actuel pour satisfaire une attente des clients. Depuis 25 ans,
		...
		<p>
			<span lang="FR" xml:lang="FR"
				...
				conservera la fraîcheur du lieu, le salon des Fées vous attend…</span
			>
		</p>
		<p>
			<span lang="FR" xml:lang="FR"
		...
		<p>
			<span lang="FR" xml:lang="FR"
				...
				sauront vous donner l’énergie à proximité de notre cascade et son bassin
				ils sauront vous ressourcer et vous donner l’énergie pour la découverte
				de notre magnifique Jura… A votre retour, un choix de produits régionaux
				ou gourmets préparé avec soin par la fée de la maison saura égaillé vos
				papilles gustatives, le tout dans un panier pick nick prêt à l’emploi
				que vous aurez la possibilité de découvrir soit dans notre parc ou
				plutôt au bord de l’eau ou sur la terrasse ou encore àl’étage et son
		...
		<p>
			...
			l'activité physique, la diététique et un style de vie sain et équilibré.
			Pour en savoir plus
			<a
				href="/sites/desfees.fr/files/fichiers/pdf/Kneippwalk.pdf"
				target="_blank"
				>consultez le PDF</a
			>.
		</p>
		...
		<p>
			...
			de grandes randonnées passe devant la ferme. Des luges, boules de pétanque
			sont à votre disposition, elle peut également vous organiser : Des parties
			de pêche en rivière, des ballades équestres, VTT, vol en montgolfière,
			avion, parapente, <strong>sur commande</strong> arrangements floraux,
			bouquets de fleurs, paniers pique-niques, différents massages de
			bien-être&nbsp;et si d’autres envies vous saisissent parlez nous-en, nous,
